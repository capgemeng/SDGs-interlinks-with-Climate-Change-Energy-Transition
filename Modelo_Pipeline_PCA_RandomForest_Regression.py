'''
NAME
    Modelo_Pipeline_PCA_RandomForest_Regression
...
DESCRIPTION
    Code for the Pipeline PCA RandomForest Regression model

REQUIREMENTS
    See file ./notebooks/project_resume.ipynb

FILE
    ./Modelo_Pipeline_PCA_RandomForest_Regression.py

This script contains the code for the Pipeline PCA RandomForest Regression model.
